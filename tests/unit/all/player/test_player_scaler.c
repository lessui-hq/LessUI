/**
 * test_player_scaler.c - Unit tests for video scaling calculations
 *
 * Tests the pure scaling calculation functions extracted from player.c.
 ...
 *
 * Test coverage:
 * - PlayerScaler_applyRotation - Dimension swapping for rotated displays
 * - PlayerScaler_calculateAspectDimensions - Aspect ratio calculations
 * - PlayerScaler_clampToBuffer - Buffer bounds checking
 * - PlayerScaler_calculate - Full scaling calculation
 */
...
///////////////////////////////
// PlayerScaler_applyRotation tests
///////////////////////////////

void test_applyRotation_none(void) {
	int w = 320, h = 240;
	PlayerScaler_applyRotation(SCALER_ROTATION_NONE, &w, &h);
...
void test_applyRotation_90_swaps_dimensions(void) {
	int w = 320, h = 240;
	PlayerScaler_applyRotation(SCALER_ROTATION_90, &w, &h);
...
void test_applyRotation_180_no_swap(void) {
	int w = 320, h = 240;
	PlayerScaler_applyRotation(SCALER_ROTATION_180, &w, &h);
	TEST_ASSERT_EQUAL_INT(320, w);
	TEST_ASSERT_EQUAL_INT(240, h);
}
...
void test_applyRotation_270_swaps_dimensions(void) {
	int w = 320, h = 240;
	PlayerScaler_applyRotation(SCALER_ROTATION_270, &w, &h);
	TEST_ASSERT_EQUAL_INT(240, w);
	TEST_ASSERT_EQUAL_INT(320, h);
}
...
///////////////////////////////
// PlayerScaler_calculateAspectDimensions tests
///////////////////////////////

void test_aspectDimensions_4_3_aspect(void) {
	int out_w, out_h;
	PlayerScaler_calculateAspectDimensions(256, 224, 4.0 / 3.0, &out_w, &out_h);
...
void test_aspectDimensions_1_1_aspect(void) {
	int out_w, out_h;
	PlayerScaler_calculateAspectDimensions(256, 256, 1.0, &out_w, &out_h);
...
void test_aspectDimensions_16_9_aspect(void) {
	int out_w, out_h;
	PlayerScaler_calculateAspectDimensions(320, 240, 16.0 / 9.0, &out_w, &out_h);
...
void test_aspectDimensions_wide_source(void) {
	...
	PlayerScaler_calculateAspectDimensions(640, 200, 4.0 / 3.0, &out_w, &out_h);
...
///////////////////////////////
// PlayerScaler_clampToBuffer tests
///////////////////////////////

void test_clampToBuffer_within_bounds(void) {
	PlayerScalerResult result = {.dst_w = 640, .dst_h = 480, .dst_p = 1280, .dst_x = 0, .dst_y = 0};

	bool clamped = PlayerScaler_clampToBuffer(&result, 960, 720, 2);
...
void test_clampToBuffer_exceeds_width(void) {
	PlayerScalerResult result = {.dst_w = 1200, .dst_h = 480, .dst_p = 2400, .dst_x = 100, .dst_y = 50};
...
void test_clampToBuffer_exceeds_height(void) {
	PlayerScalerResult result = {.dst_w = 640, .dst_h = 900, .dst_p = 1280, .dst_x = 0, .dst_y = 0};
...
void test_clampToBuffer_adjusts_offsets(void) {
	PlayerScalerResult result = {.dst_w = 1920, .dst_h = 1080, .dst_p = 3840, .dst_x = 100, .dst_y = 80};

	bool clamped = PlayerScaler_clampToBuffer(&result, 960, 540, 2);
...
///////////////////////////////
// PlayerScaler_calculate - Native mode tests
///////////////////////////////

void test_calculate_native_2x_scale(void) {
	PlayerScalerInput input = {.src_w = 256,
	                            .src_h = 224,
	                            .src_p = 512,
...
void test_calculate_native_1x_scale(void) {
	PlayerScalerInput input = {.src_w = 320,
	                            .src_h = 240,
	                            .src_p = 640,
	                            .aspect_ratio = 4.0 / 3.0,
	                            .rotation = SCALER_ROTATION_NONE,
...
///////////////////////////////
// PlayerScaler_calculate - Aspect mode tests
///////////////////////////////
...
///////////////////////////////
// PlayerScaler_calculate - Rotation tests
///////////////////////////////
...
///////////////////////////////
// PlayerScaler_calculate - Cropped mode tests
///////////////////////////////
...
///////////////////////////////
// PlayerScaler_calculate - Forced crop tests
///////////////////////////////

void test_calculate_forced_crop_large_source(void) {
	PlayerScalerInput input = {.src_w = 800,
	                            .src_h = 600,
	                            .src_p = 1600,
	                            .aspect_ratio = 4.0 / 3.0,
	                            .rotation = SCALER_ROTATION_NONE,
...
///////////////////////////////
// PlayerScaler_calculate - Oversized device tests
///////////////////////////////
...
///////////////////////////////
// PlayerScaler_calculate - Buffer clamping tests
///////////////////////////////
...
///////////////////////////////
// PlayerScaler_calculate - Zero aspect ratio tests
///////////////////////////////
