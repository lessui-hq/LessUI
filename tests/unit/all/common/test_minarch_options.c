/**
 * test_minarch_options.c - Unit tests for MinArch option management
 *
...
// Test fixtures
static MinArchOptionList test_list;
static MinArchOption options[3];

void setUp(void) {
	memset(&test_list, 0, sizeof(MinArchOptionList));
