#!/bin/sh
# NOTE: becomes .tmp_update/retroid.sh
...
boot_log "LESSOS_DEVICE=$LESSOS_DEVICE"
boot_log "LESSOS_STORAGE=$LESSOS_STORAGE"

# CPU setup (Snapdragon 865 - use userspace governor for manual control)
