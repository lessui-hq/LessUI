...
Platform implementation for Rockchip RK3566-based retro handheld devices (LessOS).

## Supported Devices
- PowKiddy RGB30
- Anbernic RG353P/M/V/VS (future)
...
│   └── init.sh             Entry point
├── .system/
│   ├── RK3566/             Platform-specific binaries
...
│   └── RK3566/             Platform-specific settings
