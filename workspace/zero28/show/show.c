// zero28 - Display an image on screen during boot/install/update
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
#include <unistd.h>
...
int main(int argc , char* argv[]) {
	...
	if (rotate) SDL_RenderCopyEx(renderer,texture,NULL,&(SDL_Rect){h,0,w,h},rotate*90,&(SDL_Point){0,0},SDL_FLIP_NONE);
