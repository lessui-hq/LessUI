...
output_dir="$build_dir/SYSTEM/$platform/paks/LessUI.pak"
...
echo "  Generating LessUI.pak for $platform"
...
if [ "$arch" = "arm32" ]; then
	platform_arch="arm"
	cores_subpath=".system/common/cores/arm32"
else
	platform_arch="arm64"
	cores_subpath=".system/common/cores/arm64"
fi
