/**
 * minarch_scaler.h - Video scaling calculation utilities
 *
...
#ifndef __MINARCH_SCALER_H__
#define __MINARCH_SCALER_H__
...
typedef struct {
	...
	MinArchRotation rotation; /**< Video rotation */
	MinArchScalerMode mode; /**< Scaling mode */
