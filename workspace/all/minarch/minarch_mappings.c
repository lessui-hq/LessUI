/**
 * minarch_mappings.c - Static button/label data for MinArch
 *
...
char* minarch_onoff_labels[] = {"Off", "On", NULL};

char* minarch_scaling_labels[] = {"Native", "Aspect", "Fullscreen", "Cropped", NULL};

char* minarch_effect_labels[] = {"None", "Lines", "Grid", "Grille", "Slot", NULL};

char* minarch_sharpness_labels[] = {"Sharp", "Crisp", "Soft", NULL};

char* minarch_max_ff_labels[] = {
    "None", "2x", "3x", "4x", "5x", "6x", "7x", "8x", NULL,
};

char* minarch_overclock_labels[] = {
...
char* minarch_gamepad_labels[] = {
    "Standard",
    "DualShock",
    NULL,
};

char* minarch_gamepad_values[] = {
    "1",
    "517",
    NULL,
};
...
MinArchButtonMapping minarch_default_button_mapping[] = {
    {.name = "Up",
...
MinArchButtonMapping minarch_button_label_mapping[] = {
    {.name = "NONE",
     .retro_id = -1,
...
const char* minarch_device_button_names[LOCAL_BUTTON_COUNT] = {
    [BTN_ID_DPAD_UP] = "UP",
