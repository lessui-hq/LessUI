/**
 * minarch_menu_types.h - Menu system type definitions for MinArch
 *
...
#ifndef MINARCH_MENU_TYPES_H
#define MINARCH_MENU_TYPES_H
 ...
 * Used by MinArchMenuNav_* functions for testable navigation logic.
 */
typedef struct MinArchMenuNavState {
 ...
 *
 * Returned by MinArchMenuNav_handleAction() to indicate what
