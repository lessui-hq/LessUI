/**
 * launcher_launcher.h - ROM and PAK launcher utilities
 *
...
#ifndef __LAUNCHER_LAUNCHER_H__
#define __LAUNCHER_LAUNCHER_H__
 ...
 */
#define LAUNCHER_MAX_CMD_SIZE 1024
 ...
 *
 * @param cmd Output buffer for command (min LAUNCHER_MAX_CMD_SIZE bytes)
