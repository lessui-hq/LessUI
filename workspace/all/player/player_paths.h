/**
 * player_paths.h - Path generation utilities for Player save files
 *
...
#ifndef __PLAYER_PATHS_H__
#define __PLAYER_PATHS_H__
 ...
 * Example: "/mnt/SDCARD/.userdata/miyoomini/gpsp/player-rg35xx.cfg"
 *
 * @param filename Output buffer (min MAX_PATH bytes)
