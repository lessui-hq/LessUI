/**
 * player_game.h - Game file loading utilities
 *
...
#ifndef __PLAYER_GAME_H__
#define __PLAYER_GAME_H__
 ...
 */
#define PLAYER_MAX_EXTENSIONS 32
 ...
 *   char* ext_array[32];
 *   int count = PlayerGame_parseExtensions(exts, ext_array, 32);
 *   // count=3, ext_array={"gb","gbc","zip",NULL}
 */
int PlayerGame_parseExtensions(char* extensions_str, char** out_extensions, int max_extensions);
 ...
 */
bool PlayerGame_matchesExtension(const char* filename, char* const* extensions);
 ...
 */
bool PlayerGame_detectM3uPath(const char* rom_path, char* out_m3u_path, size_t m3u_path_size);
 ...
 */
bool PlayerGame_buildM3uPath(const char* rom_path, char* out_m3u_path, size_t m3u_path_size);

#endif // __PLAYER_GAME_H__
